...
const req = https.request('https://crreoeautoqzcgtlwlsd.supabase.co/rest/v1/tata_spare_inventory?select=last_receipt&last_receipt=ilike.%252026-12%25', {
  ...
  res.on('end', () => console.log('Contains 2026-12:', body));
});
req.end();
