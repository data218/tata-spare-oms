...
// Replace the existing Reorder View
const reorderHtml = `
        <!-- REORDER MANAGEMENT VIEW -->
        <div id="view-reorder" class="view-section" style="display: none;">
          <div class="dashboard-content">
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 24px;">
              ...
              <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                <button id="reorder-refresh-btn" class="btn btn-outline"><i data-lucide="refresh-cw" style="width: 14px; height: 14px;"></i> Refresh</button>
              ...
              <div style="display: flex; gap: 12px; align-items: flex-start;">
                ...
                <div>
                  ...
                  <p style="margin: 0; font-size: 0.85rem; color: #92400e;">
                    The system is currently using Actual Inventory (Current, Min, Max) and Historical Consumption. Fields for <strong>Pending Demand</strong>, <strong>Open POs</strong>, and <strong>In Transit Qty</strong> do not currently exist in the database and are flagged as <em>INSUFFICIENT DATA</em>. 
                  </p>
                </div>
              </div>
            </div>
...
// Replace existing reorder view
html = html.replace(/<!-- REORDER VIEW -->[\s\S]*?(?=<!-- NOTIFICATIONS VIEW -->)/, reorderHtml + '\n\n        ');

fs.writeFileSync('dashboard.html', html, 'utf8');
console.log('Updated dashboard.html for Reorder Control Tower');
