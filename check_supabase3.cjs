...
const req = https.request('https://crreoeautoqzcgtlwlsd.supabase.co/rest/v1/tata_spare_inventory?select=last_receipt&last_receipt=ilike.%2512%2F2026%25', {
  ...
  res.on('end', () => console.log('Contains /12/2026:', body));
});
req.end();
